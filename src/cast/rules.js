...
export const castAndBoat = {
  ...
  howToPlay: [
    ...
    'You may then <em>boat</em> one of the answers — it goes face up in front of you. The rest are discarded.',
    'Boating is optional. A third card that makes no set clears your boat for nothing, so taking nothing is often the better play.',
